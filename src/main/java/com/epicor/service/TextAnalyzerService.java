...
import com.epicor.utils.WordsUtil;
...
public class TextAnalyzerService {
    ...
    public AnalysisResult analyzeFromClassPath() throws Exception {
    ...
    public AnalysisResult analyzeTextFromInput(InputStream inputStream) throws Exception {
        try {
            ...
            while((line = bufferedReader.readLine()) != null){
                ...
                for (String raw : words) {
                    ...
                    String word = normalize(raw.trim());
            ...
            analysisResult.setTotalWordCount(totalWords);
            analysisResult.setTopWords(topWords);
            analysisResult.setUniqueWords(uniqueWords);
            analysisResult.setProcessingTime(durationSeconds);
